      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg">
              I have more than a decade of experience in the mobile game industry, having worked on 
              popular titles such as Clash of Clans and The Walking Dead: No Man's Land, and founded 
              two mobile game studios during that time.
            </p>
            <p className="text-lg">
              I started my career in gaming at Supercell in 2013 and advanced through the ranks at 
              several gaming startups before founding my first game studio, Skunkworks, in 2019.
            </p>
            <p className="text-lg">
              Currently, I am working on my second game studio, Voxelpop, which is at the pre-funding 
              stage.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <p className="text-lg">
              Having been in the front seat of multiple gaming startups, I have grown a wealth of 
              knowledge and experience in leadership and strategy. Coupled with a strength in 
              execution, I have been able to successfully take numerous concepts from ideation to 
              completion.
            </p>
            <p className="text-lg">
